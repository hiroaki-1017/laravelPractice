        ...
        <form>
            <div class="mx-auto py-5 px-2 flex bg-green-300 text-xl">
                ...
                <div class="text-center flex-auto px-1">
                    <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" type="button" onclick="searchTorihikisaki()">検索</button>&nbsp;&nbsp;
