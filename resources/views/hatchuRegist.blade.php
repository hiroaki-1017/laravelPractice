        ...
        <table class="text-xl mx-fixed mx-auto">
            <tr class="h-10">
                ...
                <td class="text-left w-3/12">
                    <input type="text" name="hatchu_seq" value="{{ old('hatchu_seq') }}" readonly>
                </td>
                <td class="w-2/12"></td>
                <th class="w-2/12 text-left">入荷数</th>
                <td class="w-3/12 text-left">
                    <input type="number" name="nyuka_su" value="{{ old('nyuka_su') }}">
                </td>
            </tr>
            <tr class="h-10">
                ...
                <td>
                    ...
                    <select name="tenpo_code">
                        ...
                        <option value="{{ $tenpo->torihikisaki_code}}" @if($tenpo->torihikisaki_code == old('tenpo_code')) selected @endif>
                ...
                <td class="text-left">
                    <select name="hatchu_kbn">
                        <option value="1" @if( old('hatchu_kbn')=='1' ) selected @endif>メディコード</option>
                        <option value="2" @if( old('hatchu_kbn')=='2' ) selected @endif>その他</option>
                        <option value="3" @if( old('hatchu_kbn')=='3' ) selected @endif>EPI</option>
                    </select>
                </td>
            </tr>
            <tr class="h-10">
                ...
                <td class="text-left">
                    <input type="text" name="torihikisaki_name" id="torihikisaki_name" value="{{ old('torihikisaki_name') }}" readonly>
                    <input type="hidden" name="torihikisaki_code" id="torihikisaki_code" value="{{ old('torihikisaki_code') }}">
                </td>
                <td class="text-left">
                ...
                <td class="text-left">
                    <input type="date" name="hatchu_date" value="{{ old('hatchu_date') }}">
                </td>
            </tr>
            <tr class="h-10">
                <th class="text-left">薬品</th>
                <td class="text-left">
                    <input type="text" name="hanbai_name" id="hanbai_name" value="{{ old('hanbai_name') }}">
                    <input type="hidden" name="yj_code" id="yj_code" value="{{ old('yj_code') }}">
                    <input type="hidden" name="yakuhin_kbn" id="yakuhin_kbn" value="{{ old('yakuhin_kbn') }}">
                </td>
                <td class="text-left">
                ...
                <td class="text-left">
                    <select name="shori_kbn">
                        <option value="1" @if(old('shori_kbn')=='1' ) selected @endif>未納品</option>
                        <option value="2" @if(old('shori_kbn')=='2' ) selected @endif>納品中</option>
                        <option value="3" @if(old('shori_kbn')=='3' ) selected @endif>納品済</option>
                    </select>
                </td>
            </tr>
            <tr class="h-10">
                ...
                <td class="text-left">
                    <input type="text" name="jan_code" id="jan_code" value="{{ old('jan_code')}}">
                </td>
                <td></td>
                <th class="text-left">照合フラグ</th>
                <td class="text-left">
                    <select name="">
                        <option value="0" @if(old('shogo_flg')=='0' ) selected @endif>未照合</option>
                        <option value="1" @if(old('shogo_flg')=='1' ) selected @endif>照合済</option>
                    </select>
                </td>
            </tr>
            <tr class="h-10">
                ...
                <td class="text-left">
                    <input type="number" name="hatchu_su" id="hatchu_su" value="{{ old('hatchu_su') }}">
                </td>
                <td></td>
                <th class="text-left">備考</th>
                <td class="text-left">
                    <input type="text" name="biko" value="{{ old('biko') }}">
                </td>
            </tr>
            <tr class="text-left">
                ...
                <td class="text-left">
                    <select name="suryo_kbn">
                        <option value="1" @if(old('suryo_kbn')=='1' ) selectd @endif>箱</option>
                        <option value="2" @if(old('suryo_kbn')=='2' ) selectd @endif>バラ</option>
                    </select>
                </td>
